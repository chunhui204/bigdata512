...
#include "../../cameraTEST/videosurface.h"
...
QT_MOC_LITERAL(1, 13, 14), // "framePresented"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5) // "frame"

    },
    "VideoSurface\0framePresented\0\0frame"
};
...
void VideoSurface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->framePresented((*reinterpret_cast< const QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (VideoSurface::*_t)(const QImage & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&VideoSurface::framePresented)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoSurface::framePresented(const QImage & _t1)
{
