...
SpectrumThread::SpectrumThread(QObject *parent) : QObject(parent)
{
    ...
    connect(m_timer, &QTimer::timeout, this, &SpectrumThread::timeout);
...
{
    qcout << "spectrum thread: " << QThread::currentThreadId();
